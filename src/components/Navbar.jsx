...
const Navbar = () => {
  ...
  return (
    <div className="w-full bg-surface-highlight/40 dark:bg-surface-highlight/20 border-b px-6 sm:px-8 md:px-10 py-4 border-border transition-colors duration-300">
      <nav className="flex items-center justify-between max-w-6xl mx-auto">
        ...
        <button
          onClick={toggleTheme}
          className="p-2.5 rounded-full hover:bg-surface-highlight transition-[background-color] duration-300 flex items-center justify-center min-w-10 min-h-10 cursor-pointer"
